...
<main class="container mx-auto mt-6">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h2 class="text-center text-2xl mb-4">Edit Profilmu Sekarang!</h2>
        ...
        <form action="{{ route('pengguna.update', $pengguna->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="namalengkap" id="namalengkap" value="{{ $pengguna->namalengkap }}" placeholder="Masukkan Nama Lengkap Anda..." class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
            </div>
            <div class="mb-6">
                <label for="tanggal_lahir" class="block text-gray-700 font-bold mb-2">Tanggal Lahir</label>
                <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ $peng guna->tanggal_lahir }}" class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input type="email" name="email" id="email" value="{{ $pengguna->email }}" placeholder="Masukkan Email Lengkap Anda..." class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
            </div>
            <div class="mb-6">
                <label for="no_telp" class="block text-gray-700 font-bold mb-2">No. Telepon</label>
                <input type="tel" name="no_telp" id="no_telp" value="{{ $pengguna->no_telp }}" placeholder="Masukkan Nomor Telepon Anda..." class="w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
            </div>
            <div class="mb-6">
                <label for="image" class="block text-gray-700 font-bold mb-2">Upload File (Opsional)</label>
                <input type="file" name="image" id="image" class="block w-full text-sm text-gray-500 border rounded-full" />
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300">Update</button>
        </form>
    </div>
</main>
